...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/rocm-comgr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rocm-comgr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install rocm-comgr
```
...
It is possible to list all of the versions of `rocm-comgr` available on your platform:
...
```
pixi search rocm-comgr --channel conda-forge
```
